<?php
/**
 * storecamp\htmlelements Button class
 */
...
class Button extends RenderedObject
{
    ...
    public function render()
    {
        ...
        $instance = $this;
        $view = view('elements::button', compact('instance', 'defaults', 'attributes'));
     ...
     */
    public function getValueWithIcon()
    {
        if ($this->appendIcon) {
