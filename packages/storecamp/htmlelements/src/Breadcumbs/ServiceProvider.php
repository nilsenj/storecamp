...
class ServiceProvider extends BaseServiceProvider {
	...
	public function register()
	{
		...
		{
			$breadcrumbs = $this->app->make('storecamp\htmlelements\Breadcrumbs\Manager');
	...
	public function registerBreadcrumbs()
	{
        ...
        // Load the app breadcrumbs if they're in app/Core/Http/breadcrumbs.php (StoreCamp)
        elseif (file_exists($file = $this->app['path'].'/Core/Http/breadcrumbs.php'))
        {
            require $file;
        }
	}
